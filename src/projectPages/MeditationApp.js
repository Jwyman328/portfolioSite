      ...
      <div className="projectAboutContainer">
        ...
        <div className="projectAboutTextContainer">
          ...
          <p>
            ...
            building the app, seeing just how far I could take it. When I was
            finished I had an app far beyond what I believed I could do in just
            a few short weeks. Everything from authentication, integrating
            audio, communicating with the phone to track steps, and much more.
          </p>
          <h3>Project Challenges</h3>
          <p>
            {" "}
            Having to pick up a new technology (React Native and mobile
            development) seemed challenging but my previous experience with
            react helped lessen the learning curve. A major pitfall I fell into
            early was getting the program to deal with audio, but after lots of
            determination I finally got the audio meditations to work. As the
            program grew and grew I needed to handle the challenges of managing
            large amounts of data at each section of the program. This led me
            straight to redux. Quickly redux gave me problems as I had to
            integrate it with my API calls, but once I got redux-thunk
            middleware working, data management become easily manageable.
          </p>
        </div>
      </div>
