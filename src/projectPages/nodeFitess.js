    ...
    <div className="background-design">
      ...
      <div className="projectAboutContainer">
        ...
        <div className="projectAboutTextContainer">
          ...
          <h3>Project Story</h3>
          <p>
            This project is an adaptation of another project, the Fitness
            Challenge App. To expand my knowledge but avoiding coming up with a
            brand-new idea I rewrote the Challenge Fitness App in completely
            different technologies. The app was previously written with django,
            bootstrap/CSS, postgreSQL and vanillaJS, but this version is written
            with react, node, mongoDB, redis, django REST framework and css
            flexbox. Below is the story for the original Fitness Challenge App
          </p>
          ...
          <p>
            The main challenges I faced was taking the leap to write the program
            in a test-drive development manner. This worked out well at first
            but as the program grew, and my self-imposed time limit of two weeks
            crept closer, I saw myself abandoning strict TDD rules. Although I
            did not reach the complete code coverage I was seeking I did have to
            deal with the trade-offs of TDD, better written code, but an uptick
            in project length.
          </p>
        </div>
      </div>
